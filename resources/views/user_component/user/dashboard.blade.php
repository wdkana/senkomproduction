                    ...
                    <div class="col-md-6 wow fadeInUp">
                      <div class="container">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item" data-toggle="modal" data-target="#faq1" type="button">Bagaimana Cara Mengubah Profil?</li>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLongTitle">Cara Mengunah Profil</h5>
            ...
            <div class="modal-body">
              <ol>
                <li>Cari menu "Profil" yang ada pada Side Menu Program</li>
                <li>Klik menu tersebut</li>
                <li>Anda akan melihat sebuh tampilan untuk mengunah data profil
                  <ul>
                    <li>
                      Ketikan data profil yang akan diubah
                    </li>
                    <li>
                      lalu tekan tombol ubah data
                    </li>
                  </ul>
                </li>
              ...
              <small>
              <ul>
                 <li>Mengubah username</li>
                 <li>Mengubah nama user</li>
                 <li>Menggubah password</li>
